zonder.factory('PollService', function($http, $q) {
    ...
    getNextsComments: function(idPoll, index){
         var deferred = $q.defer();
         $http.post("http://90.11.6.61" + '/poll/getNextsComments', {id : idPoll, index : index})     
         .success(function(data){
            deferred.resolve(data);
        }).error(function(data, status){
            deferred.reject(status); 
    ...
    getNextsVotesLeft: function(idPoll, index){
         var deferred = $q.defer();
         $http.post("http://90.11.6.61" + '/poll/getNextsVotesLeft', {id : idPoll, index : index})     
         .success(function(data){
            deferred.resolve(data);
        }).error(function(data, status){
            deferred.reject(status); 
    ...
    getNextsVotesRight: function(idPoll, index){
         var deferred = $q.defer();
         $http.post("http://90.11.6.61" + '/poll/getNextsVotesRight', {id : idPoll, index : index})     
         .success(function(data){
            deferred.resolve(data);
        }).error(function(data, status){
            deferred.reject(status); 
